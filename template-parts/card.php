<?php
/**
 * Post card (Zoomit-style: image on top, red category label, title, meta).
 *
 * Accepts $args:
 *   - variant: '' | 'row'
...
<article <?php post_class( $zb_classes ); ?>>
	...
	<div class="zb-card__body">
		<?php if ( $zb_cat ) : ?>
			<a class="zb-card__cat-text" href="<?php echo esc_url( get_term_link( $zb_cat ) ); ?>"><?php echo esc_html( $zb_cat->name ); ?></a>
		<?php endif; ?>
